...
public class ProductCatalogServiceImpl implements ProductCatalogService {
    ...
    public ListProductsResp listProducts(ListProductsReq request) {
        List<ProductPo> products = productMapper.listProducts(request.getPage(), request.getPageSize(), request.getCategoryName());
    ...
    public GetProductResp getProduct(GetProductReq request) {
        ProductPo product = productMapper.getProductById(request.getId());
    ...
    public SearchProductsResp searchProducts(SearchProductsReq request) {
        List<ProductPo> products = productMapper.searchProducts(request.getQuery());
